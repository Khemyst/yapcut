We're building YapCut — a tool that takes a timecoded transcript of a stream VOD and produces an FCP XML file that Premiere Pro can import as a rough cut sequence.
...
What YapCut is and how the workflow operates
